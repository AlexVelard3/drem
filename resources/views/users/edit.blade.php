@extends('layouts.main',['activePage'=>'users','titlePage'=>'Actualizar usuario'])
@section('content') 
<div class="content">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Ingrese su nombre') }}" value="{{ old('name', $user->name) }}" required="true" aria-required="true" autofocus/>
                      @if ($errors->has('name'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('username') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" id="input-username" type="text" placeholder="{{ __('Nombre de usuario') }}" value="{{ old('username', $user->username) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" id="input-password" type="password" placeholder="{{ __('Nueva contraseña') }}" value="{{ old('password', null) }}" required="true" aria-required="true"/>
